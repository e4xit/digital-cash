...
def main(args):
    if args["serve"]:
        ...
        # logger.info("alices pub key")
        # logger.info(alice_pub_key)
        # logger.info(alice_pub_key.to_string())
        mine_genesis_block(lookup_public_key("alice"))
        alice_balance_genesis = node.fetch_balance(alice_pub_key)
        # logger.info("alice's balance at genesis is:")
        # logger.info(alice_balance_genesis)
